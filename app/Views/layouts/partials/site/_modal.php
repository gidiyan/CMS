<div id="login" class="modal">
    <div class="dialog">
        ...
        <form class="text-center border p-5 m-auto" action="">
            ...
            <div class="mb-1">
                <input class="form-control" type="email" name="email" value="" id="email_login" placeholder="Enter Your Email">
            </div>
            <div class="mb-1">
                <input class="form-control" type="password" name="username" value="" id="username_login" placeholder="Enter Your Password"></div>
...
<div id="register" class="modal">
    <div class="dialog">
        ...
        <form class="text-center border p-5" action="">
            ...
            <div class="row tb-1  m-auto">
                <input class="form-control text-center" type="password" name="username" value="" id="username_register" placeholder="Enter Your Password">
                <input class="form-control text-center" type="password" name="username" value="" id="username_register" placeholder="Confirm Your Password">
            </div>
