    ...
    <div class="card">
        <div class="card-header text-center">
            <strong class="card-title"> <span data-feather="file-text"></span><?php echo $title; ?></strong><a
                    href="/admin/categories/create" class="btn btn-primary text-center float-right"><span
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        <?php foreach ($categories as $category): ?>
                            <tr>
                                ...
                                <td class="text-center"><a href="/admin/categories/show/<?= $category->id ?>"
                                                           class="btn btn-default"><span data-feather="eye"></span>View</a>
                                    <a href="/admin/categories/edit/<?= $category->id ?>" class="btn btn-primary"><span
                                                data-feather="edit"></span>Edit</a>
                                    <a href="/admin/categories/delete/<?= $category->id ?>" class="btn btn-danger"><span
