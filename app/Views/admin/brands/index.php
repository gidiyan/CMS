<div class="col">
    <div class="card">
        <div class="card-header text-center">
            <strong class="card-title"> <span data-feather="file-text" ></span><?php echo $title; ?></strong><a href="/admin/brands/create" class="btn btn-primary text-center float-right"><span data-feather="plus"></span> Add New</a>
        </div>
        <div class="card-body">
...
<?php foreach ($brands as $brand):    ?>
                    <tr>
                        ...
                        <td class="text-center"><a href="/admin/brands/show/<?=$brand->id?>" class="btn btn-default"><span data-feather="eye"></span>View</a>
